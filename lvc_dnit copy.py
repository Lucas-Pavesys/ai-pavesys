    ...
    def df2calc(self):
        ...
        for col in self.solos:
            ...
            for i in range(len(mask) - 1):
                ...
                prop_ext = round((self.intervalo/1000) / (abs(round(selected_rows["Início"].iloc[0] - selected_rows["Fim"].iloc[-1],3))),3)
                ...
                if col == 'P' or col == 'R':
                    df_lvc[col].at[x] = lc.cod_pnl_rmd(count)
                else:
                    df_lvc[col].at[x] = lc.cod_demais((count * 1000 / self.intervalo))
        ...
        for i in range(len(mask) - 1):
            ...
            for col in self.AF:
                ...
                for value in selected_rows[col]:
                    if value == 'x':
                        count += 1
            df_lvc['AF'].at[x] = lc.cod_demais((count * 1000 / self.intervalo))
            x += 1
        ...
        for i in range(len(mask) - 1):
            ...
            for col in self.TR:
                ...
                for value in selected_rows[col]:
                    if value == 'x':
                        count += 1
            df_lvc['TR'].at[x] = lc.cod_demais((count * 1000 / self.intervalo))
            x += 1
        ...
        for i in range(len(mask) - 1):
            ...
            for col in self.TB:
                ...
                for value in selected_rows[col]:
                    if value == 'x':
                        count += 1
            df_lvc['TB'].at[x] = lc.cod_demais((count * 1000 / self.intervalo))
            x += 1
